...
test.describe('UI smoke pass', () => {
  test('guest flow reaches mode and multiplayer screens cleanly', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: testInfo.outputPath('04-pvp-room-screen.png'), fullPage: true });
  ...
  test('solo game screen loads and mobile controls render on small devices', async ({ page }, testInfo) => {
    ...
    await page.screenshot({ path: testInfo.outputPath('05-game-screen.png'), fullPage: true });
